export const WebDeveloperPageData = {
  profile: {
    name: 'Alexis Aldrete',
    slogan: "I build things for the Web",
    whoAmI: 'I’m a Frontend Developer with almost 4 years of Full Stack experience in the Software Industry. I have worked in Web and Mobile Applications from developing the frontend by designing, creating and improving a user interface, to the backend by implementing software architecture, testing, and integrating, following good coding practices.',
    socialMedias: [
      {
...
export default WebDeveloperPageData;
